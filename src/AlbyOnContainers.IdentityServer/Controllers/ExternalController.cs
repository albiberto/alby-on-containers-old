...
namespace IdentityServer.Controllers
{
    ...
    public class ExternalController : Controller
    {
        ...
        readonly ILogger<ExternalController> _logger;
        ...
        async Task<(ApplicationUser user, string provider, string providerUserId, IEnumerable<Claim> claims
                )>
        ...
        async Task<ApplicationUser> AutoProvisionUserAsync(string provider, string providerUserId,
        ...
        void ProcessLoginCallback(AuthenticateResult externalResult, List<Claim> localClaims,
